...
| `checks/check_curve.py`, `checks/check_regimes.py` | The batteries: sympy identities, the code against the algebra, the stylised cycle, the regime mixtures. They gate everything. |
