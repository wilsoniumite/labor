...
| `code/exposure.py` | Who is exposed to which wave: employment by occupation group (cognitive ISCO 1-4, in-person 5, physical 6-9) in the four regions, each group's pay against the average, and how each moved in the 2008-10 recession (ILOSTAT). |
