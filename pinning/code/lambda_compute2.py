...
import os, time
CACHE = os.path.normpath(os.path.join(os.path.dirname(os.path.abspath(__file__)), os.pardir, "cache"))  # pinning/cache, whatever the cwd
...
if __name__ == "__main__":
    ...
    fig.tight_layout(); fig.savefig("data/lambda_band.png", dpi=150)
    print("\nwrote data/lambda_results.csv and data/lambda_band.png")
