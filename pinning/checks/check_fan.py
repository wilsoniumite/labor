...
# Proposition fork(iv) in paper/main.tex, and the measured
# numbers its Section 9 fork paragraph quotes (from the fan CSV built by
# effort/code/build_fig3_realwage_fan.py). House rule: sympy
...
csv_path = Path(__file__).resolve().parents[1] / "effort" / "data" / "fig3_realwage_fan.csv"
