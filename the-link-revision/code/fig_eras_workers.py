...
# (bottom). Supersedes fig_eras.py (kept; its PNG untouched).
#
...
def draw_panel(ax, eras, title, notes):
    for e in eras:
        col = COLOR[e["key"]]
    ...
    ax.set_title(title, loc="left", fontsize=11, fontweight="bold", color="#333333", pad=8)
...
draw_panel(ax1, entrant, "Untrained entrant", [
...
draw_panel(ax2, trained, "Worker with training or experience", [
...
fig.savefig("figures/fig_eras_workers.png", bbox_inches="tight")
print("wrote figures/fig_eras_workers.png")
