"""
fig_kappa_measurement.py — the-link-revision
...
Reads the built grid (link-repo/data/kappa_results.csv — regenerate with
link-repo/code/feasibility_kappa.py). Writes latex/figures/
fig_kappa_measurement.png. The prior artwork fig_kappa.png is untouched.

Run from the repo root:
    ./venv/Scripts/python.exe the-link-revision/code/fig_kappa_measurement.py
"""
...
GRID = ROOT.parent / "link-repo" / "data" / "kappa_results.csv"
OUT = ROOT / "latex" / "figures" / "fig_kappa_measurement.png"
...
ax.set_title("Rent-funded-floor coverage: two measures of U.S. site rents")
