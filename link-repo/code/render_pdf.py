...
Usage:
    venv\Scripts\python.exe link-repo\code\render_pdf.py <file-url-of-html> <output.pdf>

e.g.
    venv\Scripts\python.exe link-repo\code\render_pdf.py ^
        "file:///C:/Users/s6068C/GitHub/laborformal/link-repo/paper/the_link.html" ^
        "link-repo\paper\the_link_new.pdf"
