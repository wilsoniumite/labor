"""
build_fig3_realwage_fork.py — effort-accounting thread
...
Construction is the house-established one (link-repo/code/deflator_fork.py;
the-link-revision/docs/talk_data_briefing.md §1): AHETPI monthly average
...
Run from the repo root:
    ./venv/Scripts/python.exe effort-accounting/code/build_fig3_realwage_fork.py [--refresh]
"""
...
BASE_YEAR = 1964
# Level sanity anchors at 2023 annual means (from link-repo/code/deflator_fork.py).
SANITY_2023 = {"wage": (26, 32), "durables": (105, 140), "shelter": (350, 420)}
# Fork anchors documented in the-link-revision/docs/talk_data_briefing.md
