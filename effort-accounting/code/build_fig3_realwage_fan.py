"""
build_fig3_realwage_fan.py — effort-accounting thread

The deflator FAN (exploratory VARIANT, her asks 2026-09-01: "I also would
...
Run from the repo root:
    ./venv/Scripts/python.exe effort-accounting/code/build_fig3_realwage_fan.py [--refresh]
"""
...
OUT_PNG = ROOT / "figures" / "FIG3_realwage_fan_1950.png"
...
def main() -> int:
    ...
    ax.set_title("The deflator fork: the same U.S. paycheck against four consumption categories")
